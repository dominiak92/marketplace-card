        ...
        <div className="grid sm:grid-cols-2 border-t border-l border-zinc-800">
          {productCategories.map((cat) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative border-b border-r border-zinc-800 p-8 sm:p-10 hover:bg-zinc-900/70 transition-colors duration-300 overflow-hidden"
            >
              {/* Ghosted number */}
              <span
              ...
              {/* Link */}
              <span className="inline-flex items-center gap-2 text-[10px] font-semibold tracking-[0.25em] uppercase text-white/25 group-hover:text-white/65 transition-colors duration-200">
                Sprawdź ofertę
